<%@ Page Title="" Language="C#" MasterPageFile="~/AllUsers.master" AutoEventWireup="true" CodeFile="Vacancies.aspx.cs" Inherits="Vacancies" %>
                ...
                <ItemTemplate>
                    <tr class="row">                        
                        ...
                        <td class="v_otherinfo">
                            ...
                            NavigateUrl='<%# Eval("JobId", "JobDescription.aspx?jid={0}") %>'>نمايش ...</asp:HyperLink>
                        </td>                    
                    </tr>
                </ItemTemplate>
