<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/administratorMPage.master" AutoEventWireup="true" CodeFile="GetApplicants.aspx.cs" Inherits="Administrator_GetApplicants" %>
                        ...
                        <tr class="row">                            
                            ...
                            <td>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ApplicantId", "ShowApplicantCV.aspx?aid={0}") %>'>مشاهده رزومه ...</asp:HyperLink>
                            </td>
                        </tr>                    
                </ItemTemplate>
                <FooterTemplate>
