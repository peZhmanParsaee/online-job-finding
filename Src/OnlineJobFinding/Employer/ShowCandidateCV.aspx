<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/employerMPage.master" AutoEventWireup="true" CodeFile="ShowCandidateCV.aspx.cs" Inherits="Employer_ShowCandidateCV" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="SubmitButton">
        <asp:Button runat="server" ID="btnEmplyment" Text="استخدام كارجو" 
            onclick="btnEmplyment_Click" />
    </div>
</asp:Content>
