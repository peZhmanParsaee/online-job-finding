<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/employerMPage.master" AutoEventWireup="true" CodeFile="ShowApplicantCV.aspx.cs" Inherits="Employer_ShowApplicantCV" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Button runat="server" ID="SelectJobForDavat" Text="ارسال دعوت نامه" 
        onclick="SelectJobForDavat_Click" />
    </div>
</asp:Content>
