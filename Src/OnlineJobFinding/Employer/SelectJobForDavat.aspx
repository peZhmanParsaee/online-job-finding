<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/employerMPage.master" AutoEventWireup="true" CodeFile="SelectJobForDavat.aspx.cs" Inherits="Employer_SelectJobForDavat" %>
...
<p id="subject">ليست فرصتهاي شغلي من</p>
    <p>
        كارفرماي محترم، براي اينكه بتوانيد براي كارجو دعوت نامه بفرستيد لطفا شغل مورد نظر خود را
        انتخاب كنيد. كارجو مي تواند براي به دست آوردن اين شغل ابراز علاقه كند.
    </p>
                ...
                <ItemTemplate>
                    <tr class="row">                        
                        ...
                        <td class="v_otherinfo">
                            ...
                            NavigateUrl='<%# Eval("JobId", "SendDavatNameh.aspx?jid={0}&aid=") + Request.QueryString["aid"] %> '>انتخاب ...</asp:HyperLink>
                        </td>                    
                    </tr>
                </ItemTemplate>
